  ...
  @foreach($data as $row)
   <tr>
      ...
      <th>
            ...
            {!! Form::open(['url' => 'incomecategories/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}

<a href="{{ url("incomecategories/".$row->id."/edit")}}" class="btn btn-warning" data-toggle="tooltip"  title="@lang('fleet.editIncomeType')"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
