        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                  <div class="row">
                  <div class="col-md-3">
                     @lang('fleet.todayIncome'): <strong>{{ $total}}</strong>
                  </div>

                  <div class="col-md-6 pull-right" >
                  {!! Form::open(['url'=>'/income_records','class'=>'form-inline']) !!}
...
<table class="table" id="data_table">
  ...
  @foreach($today as $row)
     <tr>
      ...
      <td>{{$row->mileage}}</td>
      <td>
        {!! Form::open(['url' => 'income/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
